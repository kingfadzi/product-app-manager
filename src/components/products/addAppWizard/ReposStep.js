...
import { Form, Table, Badge, Alert, InputGroup, ListGroup, Button } from 'react-bootstrap';
...
function RepoLookupSection({ onAdd }) {
  const { searchTerm, setSearchTerm, results, reset } = useSearchableAPI('/api/repos/search');
